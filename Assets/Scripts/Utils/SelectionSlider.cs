...
namespace Interactive360.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
		...
		[SerializeField] private bool m_isButtonText2SpeechQues;
		[SerializeField] private bool m_isButtonText2SpeechAns;
		[SerializeField] private bool m_isButtonSpeech2Text;
        ...
        private IEnumerator FillBar ()
        {
            ...
            m_BarFilled = true;
			if (m_isButtonSpeech2Text == true) {
				SpeechToText.instance.StartRecording("Speak any");
			} else if (m_isButtonText2SpeechQues == true){
				TextToSpeech.instance.StartSpeak (GameManagerEng.instance.getCurrentQuestion());
			}
			else if (m_isButtonText2SpeechAns == true){
				TextToSpeech.instance.StartSpeak (GameManagerEng.instance.getCurrentAnswer());
			}
			else{
